...
class Employee(Base):
    def __init__(self, first_name, last_name, password, email, birth_date, address_id, salary):
        self.first_name = first_name
        self.last_name = last_name
        self.password = password
        self.email = email
    ...
    def insert(self):
        query = f"""
        INSERT INTO customer(first_name, last_name, password, email, birth_date, address_id, salary) 
        VALUES('{self.first_name}', '{self.last_name}', '{self.password}', '{self.email}', '{self.birth_date}', {self.address_id}, {self.salary})"""
        return Database.connect(query, "insert")
...
class Payment(Base):
    def __init__(self, amount, official_detail_id, payment_type_id):
        self.amount = amount
    ...
    def insert(self):
        query = f"""INSERT INTO {self.table_name}(amount, official_detail_id, payment_type_id) 
        VALUES({self.amount}, {self.official_detail_id}, {self.payment_type_id});"""
        return Database.connect(query, "insert")
...
class Salary(Base):
    ...
    def insert(self):
        query = f"""INSERT INTO store(amount, employee_id) VALUES({self.amount}, {self.employee_id})"""
        return Database.connect(query, "insert")
