from classes import (Category, Product, Color, ProductDetail, City,
                     Address, Customer, Employee, OfficialDetail, PaymentType, Payment, Store, Salary)
...
def employee_table():
    ...
    if services == "1":  # SELECT
        if len(Employee.select("employee")) == 0:
            print("Data not yet exist!")

        else:
            for i in Employee.select("employee"):
                print(f"""
                        ID: {i[0]},
                        First Name: {i[1]},
                        Last Name: {i[2]},
        ...
        customer_5 = input("Birth Date: ")
        customer_6 = int(input("Address ID: "))
        name = Employee(customer_1, customer_2, customer_3, customer_4, customer_5, customer_6)
        print(name.insert())
        return employee_table()
        ...
        new_data = input("New Data: ")
        if column_name.lower() == "id":
            print(Employee.update_id(int(old_data), int(new_data)))
        else:
            print(Employee.update(column_name.lower(), old_data, new_data))
        ...
        value = input("Data: ")
        if column_name == "id":
            print(Employee.delete_id("employee", value))
        else:
            print(Employee.delete("employee", column_name, value))
        return employee_table()
...
def salary_table():
    ...
    if services == "1":  # SELECT
        if len(Salary.select("salary")) == 0:
            print("Data not yet exist!")

        else:
            for i in Salary.select("salary"):
                print(f"""
                        ID: {i[0]},
                        Name: {i[1]},
                        Address ID: {i[2]},
        ...
        store_1 = input("Name: ")
        store_2 = int(input("Employee ID: "))
        name = Salary(store_1, store_2)
        print(name.insert())
        return store_table()
        ...
        new_data = input("New Data: ")
        if column_name.lower() == "id":
            print(Salary.update_id(int(old_data), int(new_data)))
        else:
            print(Salary.update(column_name.lower(), old_data, new_data))
        ...
        value = input("Data: ")
        if column_name == "id":
            print(Store.delete_id("salary", value))
        else:
            print(Salary.delete("salary", column_name, value))
        return salary_table()
